...
enum class EGooglePADCellularDataConfirmStatus : int {
...
enum class EGooglePADStorageMethod : int {
...
enum class EGooglePADDownloadStatus : int {
	AssetPack_UNKNOWN = 0,
...
enum class EGooglePADErrorCode : int {
