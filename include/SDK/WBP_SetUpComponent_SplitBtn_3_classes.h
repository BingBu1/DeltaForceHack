...
namespace Dumper {
// WidgetBlueprintGeneratedClass WBP_SetUpComponent_SplitBtn_3.WBP_SetUpComponent_SplitBtn_2_C
// Size: 0x605 (Inherited: 0x558)
class UWBP_SetUpComponent_SplitBtn_2_C : public UWBP_BaseSetUpItem_C {
public:
	...
	bool Line; // 0x604(0x01)

	void SetLine(bool Line); // Function WBP_SetUpComponent_SplitBtn_3.WBP_SetUpComponent_SplitBtn_2_C.SetLine // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xfffffffec0000044
