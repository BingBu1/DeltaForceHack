...
class UWBP_SetUp_InputV2_C_def2 : public UDFHDSettingsInputPanel {
public:
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_SetUp_InputV2.WBP_SetUp_InputV2_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x72c0000000
